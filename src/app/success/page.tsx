...
const page = () => {
  return (
    <div className='flex flex-col gap-4 items-center justify-center h-screen text-center'>
        ...
        <a href="/" className='bg-[#4F46E5] text-white flex items-center mt-10 justify-center gap-2 font-semibold px-3.5 py-2.5 rounded-md'>Continue shopping <FaArrowRightLong />
        </a>
    </div>
  )
}
